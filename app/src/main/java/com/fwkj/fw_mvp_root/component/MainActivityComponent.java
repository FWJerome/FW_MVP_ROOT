...
import com.fwkj.fw_mvp_root.view.MainActivity;
 ...
 */
@ActivityScope
@Component(modules = MainActivityModule.class, dependencies = DelegateComponent.class)
public interface MainActivityComponent {
    void inject(MainActivity pMainActivity);
}
